...
If you haven’t completed these tasks, follow one of the 60-Second Guides for Kubernetes to get set up before you configure TLS. Just stop before you install and connect to the Redpanda cluster.

## Step 1: Create the cluster specification file

The Redpanda GitHub repository contains a [sample configuration file](https://github.com/redpanda-data/redpanda-examples/blob/main/docs/example-config/kubernetes/tls.yaml) you can use to enable TLS.
