...
:::important
See [Configuring Redpanda TLS on Kubernetes](./docs/../../security/kubernetes-tls.mdx) for the most up-to-date instructions using the Redpanda Helm chart. This page is preserved for backward compatibility.
:::
