...
If you haven’t completed these tasks, follow one of the [60-Second Guides for Kubernetes](../index) to get set up before you configure TLS. Just stop before you install and connect to the Redpanda cluster.
