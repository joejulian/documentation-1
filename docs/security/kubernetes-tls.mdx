...
:::note
This page uses the latest recommended Helm chart for configuring security. For information about using the older Redpanda Operator, see [Redpanda Operator](../../reference/redpanda-operator).
:::
...
Create a YAML file containing the values to override from the defaults. For example:
...
Create a YAML file containing the values to override the defaults. For example:
